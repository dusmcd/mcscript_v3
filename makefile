...
main: main.o lexer.o token.o
	gcc $(flags) $(build_dir)/main.o $(build_dir)/lexer.o $(build_dir)/token.o \
	-o $(exec_dir)/main
...
lexer_test: lexer_test.o lexer.o token.o
	gcc $(flags) $(build_dir)/lexer_test.o $(build_dir)/token.o $(build_dir)/lexer.o \
	-o $(exec_dir)/lexer_test

parser_test: parser_test.o lexer.o parser.o token.o memory_mgr.o list.o
	gcc $(flags) $(build_dir)/parser_test.o $(build_dir)/lexer.o $(build_dir)/parser.o \
